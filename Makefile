...
HPCG_DEPS = src/CG.o src/CG_ref.o src/TestCG.o src/ComputeResidual.o \
	 ...
	 src/ComputeOptimalShapeXYZ.o src/MixedBaseCounter.o src/CheckAspectRatio.o src/OutputFile.o src/CompareGeo.o src/GeoTest.o src/TestSuit.o \
	 src/ComputeSPMVTest.o src/GeneratedTests.o
